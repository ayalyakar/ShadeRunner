...
- **Corp facilities (ambient in MVP):** five named fortified compounds — four **"Toxic Castles"** (**Hollywood Simsense Entertainments** in Hollywood, **Life-Eze Appliances**, **Moonshun Vehicles**, **Carnation Seattle**) plus **Shiawase America's** nuclear plant in Glow City (AAA anchor; pre-game history: 2013 Tritium Services meltdown, 2028 Shiawase replacement). Helicopter / tilt-rotor / Snoqualmie-River logistics. Runs against them deferred post-MVP.
- **Named hotels (ambient venues):** **Redmond Center Hotel** (Luxury; Yakuza-blackmail rumor), **Lucky Tom Hotel** (Yakuza-adjacent violence), **Skoofin Hill Manor & Eat** (cheap death-trap; owner Brion Tonugle).
- **Touristville neighborhoods (p.130):** seven named neighborhoods present in Redmond's developed strip (Sophistos, Brats Heaven, Partys, Acondole, Klingenpers, Woodlanders, Hollywood). MVP hand-crafted neighborhood TBD — candidates: **Brats Heaven** (Street tier; grittier grounding) or **Hollywood** (Low tier; Red Hot Nukes turf + Hollywood Simsense facility = built-in tension).
- **Distinctive sub-areas (ambient):** **Rat's Nest** (Rat-totem shaman community; post-MVP magical hook), **The Plastic Jungles** (metahuman squatter refuge), **Glow City** (nuclear backdrop), **Bargain Basement** (Mafia/Yakuza open-air markets), **Bellevue-border strip** (law-enforced zone).
- **Security rating:** A (Lone Star worst) across almost all of Redmond per p.130.
